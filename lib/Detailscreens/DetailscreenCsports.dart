...
class DetailscreenCsports extends StatelessWidget {
  const DetailscreenCsports({super.key, required this.sports});
  final Sports sports;
    ...
    return Scaffold(
      body: ListView(
        ...
        children: [
          ...
          Image.asset(sports.image,width: 100,height: 350,fit: BoxFit.fill,),
          Padding(
            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children:  [
                    Text(sports.p_price,style: TextStyle(fontSize: 20,color: Colors.black,fontWeight: FontWeight.bold),),
                  ],
                ),
                SizedBox(height: 5,),
                Row(
                  mainAxisAlignment:MainAxisAlignment.start,
                  children:  [
                    Text(sports.p_title,style: TextStyle(fontSize: 15,color: Colors.black),),
                  ],
                ),
          ...
          Padding(
            ...
            child: Row(
              children:  [
                ...
                Text(sports.p_condation,style: TextStyle(fontSize: 12,),),
              ],
            ),
          ),
          const Divider(height: 3,thickness: 1,),
          ...
          Padding(
            padding: EdgeInsets.all(8.0),
            child: Text(sports.description,style: TextStyle(fontSize: 12,),),
          ),
          const Divider(height: 3,thickness: 1,),
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: Row(
              children: [
                ...
                Text(sports.seller_name,style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
