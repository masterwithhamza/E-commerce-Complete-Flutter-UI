...
class DetailscreenCbirds extends StatelessWidget {

  const DetailscreenCbirds({super.key, required this.birds});
  final Birds birds;
  @override
    ...
    return Scaffold(
      body: ListView(
        ...
        children: [
          ...
          Image.asset(birds.image,width: 100,height: 350,fit: BoxFit.fill,),
          Padding(
            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children:  [
                    Text(birds.p_price,style: TextStyle(fontSize: 20,color: Colors.black,fontWeight: FontWeight.bold),),
                  ],
                ),
                SizedBox(height: 5,),
                Row(
                  mainAxisAlignment:MainAxisAlignment.start,
                  children:  [
                    Text(birds.p_title,style: TextStyle(fontSize: 15,color: Colors.black),),
                  ],
                ),
          ...
          Padding(
            ...
            child: Row(
              children:  [
                ...
                Text(birds.p_condation,style: TextStyle(fontSize: 12,),),
              ],
            ),
          ),
          const Divider(height: 3,thickness: 1,),
          const Padding(
           ...
           Padding(
            padding: EdgeInsets.all(8.0),
            child: Text(birds.description,style: TextStyle(fontSize: 12,),),
          ),
          const Divider(height: 3,thickness: 1,),
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: Row(
              children: [
                ...
                const SizedBox(width: 20,),
                 Text(birds.seller_name,style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
