...
class DetailscreenCclothes extends StatelessWidget {
  const DetailscreenCclothes({super.key, required this.Clothes});
    ...
    return Scaffold(
      body: ListView(
        ...
        children: [
          ...
          Image.asset(Clothes.image,width: 100,height: 350,fit: BoxFit.fill,),
          Padding(
            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children:  [
                    Text(Clothes.p_price,style: TextStyle(fontSize: 20,color: Colors.black,fontWeight: FontWeight.bold),),
                  ],
                ),
                SizedBox(height: 5,),
                Row(
                  mainAxisAlignment:MainAxisAlignment.start,
                  children:  [
                    Text(Clothes.p_title,style: TextStyle(fontSize: 15,color: Colors.black),),
                  ],
                ),
          ...
          Padding(
            ...
            child: Row(
              children:  [
                ...
                Text(Clothes.p_condation,style: TextStyle(fontSize: 12,),),
              ],
            ),
          ),
          const Divider(height: 3,thickness: 1,),
          ...
          Padding(
            padding: EdgeInsets.all(8.0),
            child: Text(Clothes.description,style: TextStyle(fontSize: 12,),),
          ),
          const Divider(height: 3,thickness: 1,),
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: Row(
              children: [
                ...
                Text(Clothes.seller_name,style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
