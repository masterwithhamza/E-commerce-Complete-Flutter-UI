import 'package:flipmarket/categories/Cmotorbike.dart';
import 'package:flutter/material.dart';
import 'package:url_launcher/url_launcher.dart';
class DetailscreenCmotorbike extends StatelessWidget {
  const DetailscreenCmotorbike({super.key, required this.motorcycle});
    ...
    return Scaffold(
      body: ListView(
        ...
        children: [
          ...
          Image.asset(motorcycle.image,width: 100,height: 350,fit: BoxFit.fill,),
          Padding(
            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children:  [
                    Text(motorcycle.p_price,style: TextStyle(fontSize: 20,color: Colors.black,fontWeight: FontWeight.bold),),
                  ],
                ),
                SizedBox(height: 5,),
                Row(
                  mainAxisAlignment:MainAxisAlignment.start,
                  children:  [
                    Text(motorcycle.p_title,style: TextStyle(fontSize: 15,color: Colors.black),),
                  ],
                ),
          ...
          Padding(
            ...
            child: Row(
              children:  [
                ...
                Text(motorcycle.p_condation,style: TextStyle(fontSize: 12,),),
              ],
            ),
          ),
          const Divider(height: 3,thickness: 1,),
          ...
          Padding(
            padding: EdgeInsets.all(8.0),
            child: Text(motorcycle.description,style: TextStyle(fontSize: 12,),),
          ),
          const Divider(height: 3,thickness: 1,),
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: Row(
              children: [
                ...
                Text(motorcycle.seller_name,style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
