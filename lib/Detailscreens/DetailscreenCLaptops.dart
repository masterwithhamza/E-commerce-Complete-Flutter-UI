...
class DetailscreenCLaptops extends StatelessWidget {
  const DetailscreenCLaptops({super.key, required this.laptop});
  final Laptop laptop ;
    ...
    return Scaffold(
      body: ListView(
        ...
        children: [
          ...
          Image.asset(laptop.image,width: 100,height: 350,fit: BoxFit.fill,),
          Padding(
            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children:  [
                    Text(laptop.p_price,style: TextStyle(fontSize: 20,color: Colors.black,fontWeight: FontWeight.bold),),
                  ],
                ),
                SizedBox(height: 5,),
                Row(
                  mainAxisAlignment:MainAxisAlignment.start,
                  children:  [
                    Text(laptop.p_title,style: TextStyle(fontSize: 15,color: Colors.black),),
                  ],
                ),
          ...
          Padding(
            ...
            child: Row(
              children:  [
                ...
                Text(laptop.p_condation,style: TextStyle(fontSize: 12,),),
              ],
            ),
          ),
          const Divider(height: 3,thickness: 1,),
          ...
          Padding(
            padding: EdgeInsets.all(8.0),
            child: Text(laptop.description,style: TextStyle(fontSize: 12,),),
          ),
          const Divider(height: 3,thickness: 1,),
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: Row(
              children: [
                ...
                Text(laptop.seller_name,style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
