...
import 'mcover2.dart';
import 'mcover3.dart';
class mcover4 extends StatefulWidget {
  const mcover4({Key? key}) : super(key: key);

  @override
  State<mcover4> createState() => _mcover4State();
}

class _mcover4State extends State<mcover4> {
  @override
    ...
    return Scaffold(
      body: ListView(
        ...
        children: [
          ...
          Image.asset("images/cover4.jpg",width: 100,height: 350,fit: BoxFit.fill,),
          Padding(
            ...
            child: Column(
              children: [
                ...
                Row(
                  mainAxisAlignment:MainAxisAlignment.start,
                  children: const [
                    Text("Mobile Cover Back",style: TextStyle(fontSize: 15,color: Colors.black),),
                  ],
                ),
                  ...
                  child: ElevatedButton(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 5,),
                        Container(margin:const EdgeInsets.fromLTRB(0, 0, 60, 0) ,child: const Text("IPhone 7+",style: TextStyle(fontSize: 13,fontWeight: FontWeight.bold,color: Colors.black),textAlign: TextAlign.start,)),
                        const SizedBox(height: 5,),
                  ...
                  child: ElevatedButton(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 5,),
                        Container(margin:const EdgeInsets.fromLTRB(0, 0, 60, 0) ,child: const Text("Huawai Printed",style: TextStyle(fontSize: 13,fontWeight: FontWeight.bold,color: Colors.black),textAlign: TextAlign.start,)),
                        const SizedBox(height: 5,),
