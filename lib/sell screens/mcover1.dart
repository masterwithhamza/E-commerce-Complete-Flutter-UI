...
import 'mcover3.dart';
import 'mcover4.dart';
class mcover1 extends StatefulWidget {
  const mcover1({Key? key}) : super(key: key);

  @override
  State<mcover1> createState() => _mcover1State();
}

class _mcover1State extends State<mcover1> {
  @override
    ...
    return Scaffold(
      body: ListView(
        ...
        children: [
          ...
          Image.asset("images/cover1.png",width: 100,height: 350,fit: BoxFit.fill,),
          Padding(
            ...
            child: Column(
              children: [
                ...
                Row(
                  mainAxisAlignment:MainAxisAlignment.start,
                  children: const [
                    Text("Best Mobile Cover",style: TextStyle(fontSize: 15,color: Colors.black),),
                  ],
                ),
