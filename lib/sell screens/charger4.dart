...
import 'charger1.dart';
import 'charger3.dart';
import 'handfree2.dart';
class charger4 extends StatefulWidget {
  const charger4({Key? key}) : super(key: key);

  @override
  State<charger4> createState() => _charger4State();
}

class _charger4State extends State<charger4> {
  @override
    ...
    return Scaffold(
      body: ListView(
        ...
        children: [
          ...
          Image.asset(
            "images/image8.jpg", width: 100, height: 350, fit: BoxFit.fill,),
          Padding(
            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children: const [
                    Text("RS 600", style: TextStyle(fontSize: 20,
                        color: Colors.black,
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: const [
                    Text("Best Oppo Original Charger",
                ...
                Row(
                  children: const [
                    ...
                    Text(
                      "Tayyab stationers & Photostate Bismillah Market Main Bazar\n Ariya Muhallah, Rawalpindi, 46000",
          ...
          const Padding(
            padding: EdgeInsets.all(8.0),
            child: Text(
              "100% Genuine Charger for  all andriod Mobiles\nColour: White \nType: Charger",
            ...
            child: Row(
              children: [
                ClipRRect(
                  ...
                  child: Image.asset("images/1024.png", width: 100,
                    height: 100,
                    fit: BoxFit.fill,),
                ),
                const SizedBox(width: 20,),
                const Text("Ahsan Irshad",
                  ...
                  child: ElevatedButton(
                    ...
                    child: Column(
                      children: [
                        ...
                        Image.asset("images/image6.jpg", width: 80,
                          height: 90,
                          fit: BoxFit.cover,),
                        const SizedBox(height: 5,),
                        Container(
                            margin: const EdgeInsets.fromLTRB(0, 0, 60, 0),
                            child: const Text("Desktop Charger", style: TextStyle(
                                fontSize: 13,
                                fontWeight: FontWeight.bold,
                        ...
                        Row(
                          children: const [
                            Icon(Icons.location_on, size: 15,
                                color: Colors.black),
                            Text("Tayyab stationers & Photostate...",
                              style: TextStyle(
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Column(
                      children: [
                        const SizedBox(height: 5,),
                        Image.asset("images/image5.jpg", width: 80,
                          height: 90,
                          fit: BoxFit.cover,),
                        const SizedBox(height: 5,),
                        Container(
                            margin: const EdgeInsets.fromLTRB(0, 0, 60, 0),
                            child: const Text("HT-71 Charger", style: TextStyle(
                                fontSize: 13,
                                fontWeight: FontWeight.bold,
                                color: Colors.black), textAlign: TextAlign
                                .start,)),
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Column(
                      children: [
                        const SizedBox(height: 5,),
                        Image.asset("images/image2.jpg", width: 80,
                          height: 90,
                          fit: BoxFit.cover,),
                        const SizedBox(height: 5,),
                        Container(
                            margin: const EdgeInsets.fromLTRB(0, 0, 60, 0),
                            child: const Text(
                              "New Handfree", style: TextStyle(fontSize: 13,
                                fontWeight: FontWeight.bold,
                                color: Colors.black), textAlign: TextAlign
                                .start,)),
                        const SizedBox(height: 5,),
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                            margin: const EdgeInsets.fromLTRB(0, 0, 60, 0),
                            child: const Text(
                              "IPhone 13 Pro Max", style: TextStyle(
                                fontSize: 13,
                                fontWeight: FontWeight.bold,
                                color: Colors.black), textAlign: TextAlign
                                .start,)),
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.end,
                          children: const [
                            Text("RS 250000", style: TextStyle(
                                fontSize: 15, color: Colors.black),),
                            SizedBox(width: 70,),
                            Icon(Icons.favorite_outline, size: 25,
                                color: Colors.black),
          ...
          const Padding(
            padding: EdgeInsets.all(8.0),
            child: Text(
              "1. Check and inspect the product properly before purchasing it. ",
              style: TextStyle(fontSize: 10),),
          ),
          const Padding(
            padding: EdgeInsets.all(8.0),
            child: Text(
              "2. Never pay anyting in advance or transfer money before inspecting the product. ",
              style: TextStyle(fontSize: 10),),
          ),
   const Divider(height: 3,thickness: 1,),
