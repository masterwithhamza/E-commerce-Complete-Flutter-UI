...
import 'charger2.dart';
import 'charger4.dart';
import 'handfree4.dart';
class charger3 extends StatefulWidget {
  const charger3({Key? key}) : super(key: key);

  @override
  State<charger3> createState() => _charger3State();
}

class _charger3State extends State<charger3> {
  @override
    ...
    return Scaffold(
      body: ListView(
        ...
        children: [
          ...
          Image.asset("images/image6.jpg",width: 100,height: 350,fit: BoxFit.fill,),
          Padding(
            ...
            child: Column(
              children: [
                ...
                Row(
                  mainAxisAlignment:MainAxisAlignment.start,
                  children: const [
                    Text("Best Battery Desktop Charger",style: TextStyle(fontSize: 15,color: Colors.black),),
                  ],
                ),
