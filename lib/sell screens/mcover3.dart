...
import 'mcover2.dart';
import 'mcover4.dart';
class mcover3 extends StatefulWidget {
  const mcover3({Key? key}) : super(key: key);

  @override
  State<mcover3> createState() => _mcover3State();
}

class _mcover3State extends State<mcover3> {
  @override
    ...
    return Scaffold(
      body: ListView(
        ...
        children: [
          ...
          Image.asset("images/cover3.jpg",width: 100,height: 350,fit: BoxFit.fill,),
          Padding(
            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children: const [
                    Text("RS 450",style: TextStyle(fontSize: 20,color: Colors.black,fontWeight: FontWeight.bold),),
                  ],
                ),
                SizedBox(height: 5,),
                Row(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 5,),
                        Container(margin:const EdgeInsets.fromLTRB(0, 0, 60, 0) ,child: const Text("Yellow Huawai",style: TextStyle(fontSize: 13,fontWeight: FontWeight.bold,color: Colors.black),textAlign: TextAlign.start,)),
                        const SizedBox(height: 5,),
